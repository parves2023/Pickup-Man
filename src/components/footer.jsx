    ...
    <footer className="text-gray-400 bg-gray-900 body-font">
            ...
            <div key={index} className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                {[...Array(4)].map((_, subIndex) => (
                  <li key={subIndex}>
                    <a href="#" className="text-gray-400 hover:text-white">Link {subIndex + 1}</a>
                  </li>
                ))}
              </nav>
            </div>
      ...
      <div className="bg-gray-800 bg-opacity-75">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="text-gray-400 text-sm text-center sm:text-left">Pickup Man —
            <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-500 ml-1" target="_blank">Join US</a>
          </p>
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
            {[...Array(4)].map((_, index) => (
              <a key={index} href="#" className="text-gray-400 ml-3">
                {index === 0 && (
