      ...
      <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          <iframe
            ...
            marginWidth="0"
            scrolling="no"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3652.9808553066814!2d90.4362331!3d23.7123777!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b933114fa909%3A0x1bfccb5436ac8882!2z4Kas4Ka-4KaC4Kay4Ka-IOCmleCmv-CmmuCnh-CmqA!5e0!3m2!1sen!2sbd!4v1709152106800!5m2!1sen!2sbd"
            style={{ filter: 'grayscale(.2) contrast(1.2) opacity(0.8)' }}
          />
          <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
            ...
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              <a href="mailto:example@email.com" className="text-green-400 leading-relaxed">example@email.com</a>
